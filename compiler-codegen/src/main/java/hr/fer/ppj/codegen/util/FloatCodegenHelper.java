 ...
 *
 * <p>This class provides utilities for converting float values to Q16.16 fixed-point representation
 * used by FRISC code generation.
 *
 ...
 *   <li>Bits 15-0: Fractional part (unsigned 16-bit)
 *   <li>Actual float value = stored_integer / 65536.0
 * </ul>
 *
...
public final class FloatCodegenHelper {
  ...
  /** Scaling factor for Q16.16 fixed-point representation. Value: 2^16 = 65536 */
   ...
   *
   * <ul>
   *   <li>{@code floatToQ16_16(1.0f)} → {@code 65536}
   *   <li>{@code floatToQ16_16(1.5f)} → {@code 98304}
   *   <li>{@code floatToQ16_16(0.5f)} → {@code 32768}
   *   <li>{@code floatToQ16_16(-1.0f)} → {@code -65536}
   * </ul>
   *
   ...
   *
   * <p>This is equivalent to converting the integer to float first, then to Q16.16: {@code
   * intToQ16_16(i) = floatToQ16_16((float)i)}.
   *
   * <p>Since the integer has no fractional part, this is simply: {@code i * 65536}.
   *
   ...
   *
   * <ul>
   *   <li>A decimal point ({@code .})
   *   <li>An exponent notation ({@code e} or {@code E})
   * </ul>
   *
