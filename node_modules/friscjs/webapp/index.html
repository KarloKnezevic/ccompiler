    ...
    <div class="container" style="width: 1170px">
      ...
      <div class="tab-content" style="margin-bottom: 0px;">
        ...
        <div id="frisc-sim" class="active container-fluid tab-pane" style="padding-left: 0px;">
          <div id="frisc-inputdiv" class="sidebar" style="width: 450px; height: 450px;">
          </div>

          <div class="sidebar ace_editor ace-tm" id="frisc-memorylist-hold" style="width: 450px; height: 450px; display:none;">
