 ...
 * for identifier terminals (IDN tokens), eliminating duplication across
 * multiple extractor and generator classes.
 * 
...
public final class IdentifierExtractor {
     ...
     * 
     * <p>This method traverses the parse tree depth-first, looking for
     * terminal nodes with symbol "IDN" and returns the lexeme (identifier name).
     * 
