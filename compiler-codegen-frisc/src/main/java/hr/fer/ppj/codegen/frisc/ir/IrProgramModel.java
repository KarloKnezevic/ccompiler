...
public record IrProgramModel(List<StructDef> structDefs, List<GlobalVar> globals, List<Function> functions) {
  ...
  public record StructDef(String name, List<StructField> fields) {
    public StructDef { Objects.requireNonNull(name, "name must not be null"); Objects.requireNonNull(fields, "fields must not be null"); }
  }
  public record StructField(String name, IrType type, int offset) {
    public StructField { Objects.requireNonNull(name, "name must not be null"); Objects.requireNonNull(type, "type must not be null"); }
  }
  public record GlobalVar(String name, IrType type, IrConst initializer) {
    public GlobalVar { Objects.requireNonNull(name, "name must not be null"); Objects.requireNonNull(type, "type must not be null"); }
  }
  public record Function(String name, List<Parameter> parameters, IrType returnType, int localsBytes, int alignBytes,
                         List<Slot> slots, List<Block> blocks) {
    public Function {
  ...
  public record Parameter(String name, IrType type) {
    public Parameter { Objects.requireNonNull(name, "name must not be null"); Objects.requireNonNull(type, "type must not be null"); }
  }

  public enum SlotKind { PARAM, LOCAL, SPILL }
  public record Slot(SlotKind kind, String name, int offset, IrType type) {
    public Slot { Objects.requireNonNull(kind, "kind must not be null"); Objects.requireNonNull(name, "name must not be null"); Objects.requireNonNull(type, "type must not be null"); }
  }
  ...
  public record Assign(Temp dest, Rhs rhs) implements Instruction {
    public Assign { Objects.requireNonNull(dest, "dest must not be null"); Objects.requireNonNull(rhs, "rhs must not be null"); }
  }
  public record Store(Value address, Value value, IrType storeType) implements Instruction {
    public Store { Objects.requireNonNull(address, "address must not be null"); Objects.requireNonNull(value, "value must not be null"); Objects.requireNonNull(storeType, "storeType must not be null"); }
  }
  public record VoidCall(String funcName, List<Value> args) implements Instruction {
    public VoidCall { Objects.requireNonNull(funcName, "funcName must not be null"); Objects.requireNonNull(args, "args must not be null"); }
  }

  public sealed interface Rhs permits AddrOfSymbol, AddrIndex, AddrField, Load, BinOp, CmpOp, Call, UnaryOp, CastOp, ConstRhs {}
  public record AddrOfSymbol(SymbolRef symbolRef) implements Rhs {
    public AddrOfSymbol { Objects.requireNonNull(symbolRef, "symbolRef must not be null"); }
  }
  public record AddrIndex(Value base, Value index, int elemSize) implements Rhs {
    public AddrIndex { Objects.requireNonNull(base, "base must not be null"); Objects.requireNonNull(index, "index must not be null"); }
  }
  ...
  public record Load(Value address, IrType loadType) implements Rhs {
    public Load { Objects.requireNonNull(address, "address must not be null"); Objects.requireNonNull(loadType, "loadType must not be null"); }
  }

  public enum BinOpName { ADD, SUB, MUL, DIV, MOD, AND, OR, XOR, SHL, SHR }
  ...
  public enum CmpOpName { EQ, NE, LT, LE, GT, GE }
  public record CmpOp(CmpOpName op, Value left, Value right) implements Rhs {
    public CmpOp { Objects.requireNonNull(op, "op must not be null"); Objects.requireNonNull(left, "left must not be null"); Objects.requireNonNull(right, "right must not be null"); }
  }
  ...
  public enum UnaryOpName { NEG, NOT }
  ...
  public enum CastName { TRUNC, SEXT, ZEXT, PTRCAST, ITOF, FTOI }
  ...
  public record ConstRhs(IrConst constant) implements Rhs {
    public ConstRhs { Objects.requireNonNull(constant, "constant must not be null"); }
  }
  ...
  public record Const(IrConst constant) implements Value {
    public Const { Objects.requireNonNull(constant, "constant must not be null"); }
  }

  public enum SymbolRefKind { LOCAL, PARAM, GLOBAL }
  public record SymbolRef(SymbolRefKind kind, String name) {
    public SymbolRef { Objects.requireNonNull(kind, "kind must not be null"); Objects.requireNonNull(name, "name must not be null"); }
  }
  ...
  public record Jmp(String targetLabel) implements Terminator {
    public Jmp { Objects.requireNonNull(targetLabel, "targetLabel must not be null"); }
  }
