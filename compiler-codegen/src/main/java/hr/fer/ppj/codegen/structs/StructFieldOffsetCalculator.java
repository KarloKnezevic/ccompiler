 ...
 * including handling of nested structs and arrays within structs. It implements the
 * <b>struct field offset calculation algorithm</b> used throughout code generation.
 * 
 ...
 *   <li><b>Offset Assignment:</b> Assign offset = current_offset, then increment by field size</li>
 ...
 * <p><b>Layout Rules:</b>
 * <ul>
 *   <li><b>No Padding:</b> Fields are laid out back-to-back with no padding</li>
...
public final class StructFieldOffsetCalculator {
     ...
     * calculating offsets for nested structs (like Inner inside Middle), we use the correct
     * array sizes for the nested struct itself, not the parent struct.
     * 
     * @param structType the struct type to calculate offsets for
