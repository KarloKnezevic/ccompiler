 ...
 *
 * <p>This utility class encapsulates the common patterns for type conversions in FRISC assembly,
 * including calls to helper functions for float conversions.
 *
 * <p><b>Supported Conversions:</b>
 *
 * <ul>
 *   <li><b>int → float:</b> Converts integer to Q16.16 fixed-point format
 *   <li><b>float → int:</b> Converts Q16.16 fixed-point to integer (truncates)
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li><b>Argument:</b> Value to convert is pushed onto the stack
 *   <li><b>Call:</b> Helper function is called (F_I2F or F_F2I)
 *   <li><b>Return:</b> Converted value is returned in R6
 *   <li><b>Cleanup:</b> Caller removes argument from stack
 * </ul>
 *
 * <p><b>Helper Functions:</b>
 *
 * <ul>
 *   <li><b>F_I2F:</b> Converts integer to float (Q16.16 format)
 *   <li><b>F_F2I:</b> Converts float (Q16.16 format) to integer (truncates)
 * </ul>
 *
 * <p><b>Register Usage:</b>
 *
 * <ul>
 *   <li><b>R0:</b> Input value (before conversion), output value (after conversion)
 *   <li><b>R6:</b> Return value from helper function
 *   <li><b>R7:</b> Stack pointer (used for PUSH and cleanup)
 * </ul>
 *
 * <p><b>Struct Type Support:</b>
 *
 * <p>This class does not handle struct type conversions, as structs are not convertible to other
 * types in C. Struct assignments are handled separately by {@link
 * hr.fer.ppj.codegen.expr.assignment.StructAssignmentGenerator}.
 *
...
public final class TypeConverter {
   ...
   *
   * <p>This method generates code to convert an integer value to the Q16.16 fixed-point format used
   * for floats in FRISC. The conversion is performed by calling the F_I2F helper function.
   *
   * <p><b>Algorithm:</b>
   *
   * <ol>
   *   <li>Push the integer value onto the stack (argument for F_I2F)
   *   <li>Call F_I2F helper function
   *   <li>Clean up the stack (remove argument)
   *   <li>Move the result from R6 to R0
   * </ol>
   *
   * <p><b>Preconditions:</b>
   *
   * <ul>
   *   <li>R0 contains the integer value to convert
   * </ul>
   *
   * <p><b>Postconditions:</b>
   *
   * <ul>
   *   <li>R0 contains the float value (Q16.16 format)
   *   <li>Stack is unchanged (argument removed)
   * </ul>
   *
   * <p><b>Side Effects:</b>
   *
   * <ul>
   *   <li>Marks F_I2F as needed (for runtime library inclusion)
   *   <li>Modifies R0, R6, R7
   * </ul>
   */
   ...
   *
   * <p>This method generates code to convert a Q16.16 fixed-point float value to an integer. The
   * conversion truncates (discards fractional part) by calling the F_F2I helper function.
   *
   * <p><b>Algorithm:</b>
   *
   * <ol>
   *   <li>Push the float value onto the stack (argument for F_F2I)
   *   <li>Call F_F2I helper function
   *   <li>Clean up the stack (remove argument)
   *   <li>Move the result from R6 to R0
   * </ol>
   *
   ...
   *
   * <ul>
   *   <li>R0 contains the float value (Q16.16 format) to convert
   * </ul>
   *
   * <p><b>Postconditions:</b>
   *
   * <ul>
   *   <li>R0 contains the integer value (truncated)
   *   <li>Stack is unchanged (argument removed)
   * </ul>
   *
   * <p><b>Side Effects:</b>
   *
   * <ul>
   *   <li>Marks F_F2I as needed (for runtime library inclusion)
   *   <li>Modifies R0, R6, R7
   * </ul>
   *
   * <p><b>Note:</b> The conversion truncates (discards fractional part), which matches C's behavior
