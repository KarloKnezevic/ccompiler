 ...
 * 
 * <p>This class encapsulates the formatting logic for FRISC assembly code,
 * ensuring consistent formatting across all generated code. It implements
 * the <b>assembly formatting algorithm</b> that produces readable, well-aligned
 * FRISC assembly output.
 * 
 * <p><b>Design Pattern: Formatter</b>
 * 
 * <p>This class implements the <b>formatter pattern</b>, separating formatting
 * concerns from code generation logic. This provides several benefits:
 * <ul>
 *   <li><b>Consistency:</b> All generated code follows the same formatting rules</li>
 *   <li><b>Readability:</b> Well-formatted assembly is easier to read and debug</li>
 *   <li><b>Maintainability:</b> Formatting rules are centralized in one place</li>
 *   <li><b>Flexibility:</b> Formatting can be changed without modifying code generation logic</li>
 * </ul>
 * 
 * <p><b>Formatting Rules:</b>
 * 
 * <ul>
 *   <li><b>Labels:</b> Placed at the beginning of lines (no indentation).
 *       Labels may have optional comments aligned to column 32.</li>
 *   <li><b>Instructions:</b> Indented with 8 spaces to distinguish them from labels.
 *       Operands are separated by commas and spaces.</li>
 *   <li><b>Comments:</b> Aligned to column 32 and prefixed with semicolons (;).
 *       Comments provide documentation for the generated code.</li>
 *   <li><b>Data Declarations:</b> Labels (if present) are padded to 8 characters
 *       for alignment, followed by the directive and value.</li>
 * </ul>
 * 
 ...
 * <ol>
 *   <li>Build the instruction string (mnemonic + operands)</li>
 *   <li>Calculate padding needed to reach column 32</li>
 *   <li>Add spaces to pad to the target column</li>
 *   <li>Append the comment with semicolon prefix</li>
 * </ol>
 * 
 * <p>This ensures that comments start at a consistent column, making the
 * assembly code easier to read and scan.
 * 
 ...
 * <p><b>Complexity:</b>
 * <ul>
 *   <li><b>Time Complexity:</b> O(n) where n is the length of the formatted string</li>
 *   <li><b>Space Complexity:</b> O(n) for the formatted string</li>
 * </ul>
 * 
...
public final class InstructionFormatter {
     ...
     */
    public String formatInstruction(String mnemonic, String operand1, String operand2, String comment) {
     ...
     * @return formatted instruction line
     */
    public String formatInstruction(String mnemonic, String operand1, String operand2, String operand3, String comment) {
        Objects.requireNonNull(mnemonic, "mnemonic must not be null");
