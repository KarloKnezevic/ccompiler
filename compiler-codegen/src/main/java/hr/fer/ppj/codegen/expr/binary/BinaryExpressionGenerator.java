 ...
 *
 * <p>This class orchestrates the generation of code for binary operations by delegating to
 * specialized generators:
 *
 * <ul>
 *   <li>{@link ArithmeticOperationGenerator} - arithmetic operations (+, -, *, /, %)
 *   <li>{@link BitwiseOperationGenerator} - bitwise operations (&, |, ^)
 *   <li>{@link ComparisonOperationGenerator} - relational and equality operations
 *   <li>{@link FloatOperationGenerator} - float operations
 * </ul>
 *
 * <p>This class handles the grammar-level dispatch and type checking, delegating the actual code
 * generation to specialized generators.
 *
...
public final class BinaryExpressionGenerator {
   ...
   */
  public BinaryExpressionGenerator(
