 ...
 *
 * <p>This class searches the parse tree to find initializer lists for global array variables,
 * extracting constant values from array initializers.
 *
...
public final class ArrayInitializerExtractor {
  ...
  private List<String> findArrayInitializerInNode(
      NonTerminalNode node, String variableName, ArrayType arrayType) {
  ...
  private List<String> findArrayInitializerInDeclaration(
      NonTerminalNode declaration, String variableName, ArrayType arrayType) {
  ...
  private List<String> findArrayInitializerInVariableDeclaration(
      NonTerminalNode declaration, String variableName, ArrayType arrayType) {
    for (ParseNode child : declaration.children()) {
      if (child instanceof NonTerminalNode nonTerminal
  ...
  private List<String> findArrayInitializerInInitDeclaratorList(
      NonTerminalNode list, String variableName, ArrayType arrayType) {
    var children = list.children();

    if (children.size() == 1) {
      return findArrayInitializerInInitDeclarator(
          (NonTerminalNode) children.get(0), variableName, arrayType);
    } else if (children.size() == 3) {
      List<String> result =
          findArrayInitializerInInitDeclaratorList(
              (NonTerminalNode) children.get(0), variableName, arrayType);
      if (result != null) return result;
      return findArrayInitializerInInitDeclarator(
          (NonTerminalNode) children.get(2), variableName, arrayType);
    }
  ...
  private List<String> findArrayInitializerInInitDeclarator(
      NonTerminalNode declarator, String variableName, ArrayType arrayType) {
  ...
  private List<String> extractArrayInitializerValue(
  ...
  private List<String> extractListValues(NonTerminalNode listNode, boolean isChar) {
    ...
    if (children.size() == 1) {
      String value =
          ConstantValueExtractor.findConstantValue((NonTerminalNode) children.get(0), isChar);
      if (value != null) {
        values.add("%D " + value);
      }
    } else if (children.size() == 3) {
      ...
      String value =
          ConstantValueExtractor.findConstantValue((NonTerminalNode) children.get(2), isChar);
      if (value != null) {
        values.add("%D " + value);
      }
    }
