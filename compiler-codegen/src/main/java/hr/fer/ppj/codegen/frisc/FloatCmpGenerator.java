 ...
 * 
 * <p>This function implements <b>Q16.16 fixed-point comparison</b>, which returns
 * a three-way comparison result following the standard C comparison convention.
 * 
 * <p><b>Algorithm: Q16.16 Fixed-Point Comparison</b>
 * 
 * <p>The function returns:
 * <ul>
 *   <li><b>-1</b> if a < b (a is less than b)</li>
 *   <li><b>0</b> if a == b (a is equal to b)</li>
 *   <li><b>1</b> if a > b (a is greater than b)</li>
 * </ul>
 * 
 * <p><b>Why Integer Comparison Works:</b>
 * 
 * <p>Since Q16.16 values are stored as signed integers with a positive scaling
 * factor (65536), the integer ordering is preserved:
 * <ul>
 *   <li>If a < b as floats, then (a × 65536) < (b × 65536) as integers</li>
 *   <li>If a == b as floats, then (a × 65536) == (b × 65536) as integers</li>
 *   <li>If a > b as floats, then (a × 65536) > (b × 65536) as integers</li>
 * </ul>
 * 
 * <p>This is because multiplication by a positive constant preserves ordering.
 * Therefore, we can compare Q16.16 values directly using signed integer comparison.
 * 
 * <p><b>Mathematical Proof:</b>
 * 
 * <p>For any two real numbers a and b:
 * <ul>
 *   <li>If a < b, then a × 65536 < b × 65536 (since 65536 > 0)</li>
 *   <li>If a == b, then a × 65536 == b × 65536</li>
 *   <li>If a > b, then a × 65536 > b × 65536</li>
 * </ul>
 * 
 * <p>Therefore, integer comparison of the Q16.16 representations correctly
 * reflects the ordering of the original float values.
 * 
 * <p><b>Example:</b>
 * <pre>
 ...
 * <p><b>Edge Cases:</b>
 * <ul>
 *   <li><b>Negative Numbers:</b> Two's complement representation correctly
 *       handles negative comparisons (negative numbers are less than positive)</li>
 *   <li><b>Zero:</b> Zero comparison works correctly (0 == 0)</li>
 *   <li><b>Equal Values:</b> Equal comparison correctly returns 0</li>
 *   <li><b>Overflow Values:</b> Integer comparison handles overflow values
 *       correctly (though they may not represent valid floats)</li>
 * </ul>
 * 
 * <p><b>Complexity Analysis:</b>
 * <ul>
 *   <li><b>Time Complexity:</b> O(1) - single CMP instruction plus conditional jumps</li>
 *   <li><b>Space Complexity:</b> O(1) - uses only registers</li>
 * </ul>
 * 
 * <p><b>FRISC Register Usage:</b>
 * <ul>
 *   <li><b>R0:</b> Operand a</li>
 *   <li><b>R1:</b> Operand b</li>
 *   <li><b>R6:</b> Return value (-1, 0, or 1)</li>
 * </ul>
 * 
