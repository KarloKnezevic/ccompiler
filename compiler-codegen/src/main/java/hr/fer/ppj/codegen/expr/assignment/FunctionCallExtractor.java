 ...
 * 
 * <p>This utility class provides methods to extract function call information
 * from expression nodes, including handling cases where function calls are
 * wrapped in various expression wrapper nodes.
 * 
 * <p><b>Grammar Patterns Handled:</b>
 * <ul>
 *   <li>{@code <postfiks_izraz> L_ZAGRADA D_ZAGRADA} - function call without arguments</li>
 *   <li>{@code <postfiks_izraz> L_ZAGRADA <lista_argumenata> D_ZAGRADA} - function call with arguments</li>
 * </ul>
 * 
 ...
 * <ul>
 *   <li>{@code <izraz_pridruzivanja>}</li>
 *   <li>{@code <log_ili_izraz>}, {@code <log_i_izraz>}</li>
 *   <li>{@code <bin_ili_izraz>}, {@code <bin_xili_izraz>}, {@code <bin_i_izraz>}</li>
 *   <li>{@code <jednakosni_izraz>}, {@code <odnosni_izraz>}</li>
 *   <li>{@code <aditivni_izraz>}, {@code <multiplikativni_izraz>}</li>
 *   <li>{@code <cast_izraz>}, {@code <unarni_izraz>}</li>
 * </ul>
 * 
