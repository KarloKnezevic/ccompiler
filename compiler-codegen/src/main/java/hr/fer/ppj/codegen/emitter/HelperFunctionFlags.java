 ...
 *
 * <p>This class encapsulates all the boolean flags that track whether various helper functions
 * (F_MUL, F_DIV, F_FADD, etc.) need to be generated. It eliminates the need for multiple boolean
 * fields in FriscEmitter.
 *
 * <p><b>Helper Functions Tracked:</b>
 *
 * <ul>
 *   <li>Integer operations: F_MUL, F_DIV, F_MUL64
 *   <li>Float operations: F_FADD, F_FSUB, F_FMUL, F_FDIV, F_FCMP, F_I2F, F_F2I
 * </ul>
 *
