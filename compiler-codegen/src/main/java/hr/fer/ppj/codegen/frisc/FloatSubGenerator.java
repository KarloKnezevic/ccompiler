 ...
 *
 * <p>This function implements <b>Q16.16 fixed-point subtraction</b>, which is similar to addition
 * but uses subtraction instead. Like addition, subtraction is linear and preserves the fixed-point
 * scaling.
 *
 ...
 * </pre>
 *
 * <p>Since both operands are already scaled by 65536, we can simply subtract them as signed
 * integers. The result is automatically in Q16.16 format because the scaling factor is preserved.
 *
 ...
 *
 * <ul>
 *   <li>Both operands have the same scaling factor (65536)
 *   <li>Subtracting scaled values preserves the scaling: (a×s) - (b×s) = (a-b)×s
 *   <li>No overflow handling needed (32-bit signed subtraction handles it correctly)
 *   <li>The result is automatically in the correct format
 * </ul>
 *
 * <p><b>Example:</b>
 *
 ...
 *
 * <ul>
 *   <li><b>Underflow:</b> 32-bit signed subtraction correctly handles underflow (wraps around,
 *       which is acceptable for fixed-point arithmetic)
 *   <li><b>Negative Numbers:</b> Two's complement subtraction correctly handles negative operands
 *       and negative results
 *   <li><b>Zero:</b> Subtracting zero works correctly (identity operation)
 *   <li><b>Equal Operands:</b> Subtracting equal values correctly produces zero
 * </ul>
 *
 * <p><b>Complexity Analysis:</b>
 *
 * <ul>
 *   <li><b>Time Complexity:</b> O(1) - single SUB instruction
 ...
 *
 * <ul>
 *   <li><b>R0:</b> Operand a, then result
 *   <li><b>R1:</b> Operand b
