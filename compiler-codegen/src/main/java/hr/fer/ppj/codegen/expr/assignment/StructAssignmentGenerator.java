 ...
 * <ul>
 *   <li><b>Struct-to-struct assignment:</b> {@code p = q} - byte-wise memory copy</li>
 *   <li><b>Function call assignment:</b> {@code p = makePoint(...)} - optimized path using
 *       hidden return pointer</li>
 * </ul>
 * 
 ...
 *   <li><b>Address Resolution:</b> Compute addresses of source and destination structs</li>
 *   <li><b>Memory Copy:</b> Copy struct word-by-word using a loop</li>
 * </ol>
 * 
 * <p>For function call assignment ({@code p = makePoint(...)}):
 * <ol>
 *   <li><b>Address Resolution:</b> Compute destination struct address</li>
 *   <li><b>Function Call:</b> Call function with hidden return pointer in R2</li>
 *   <li><b>No Copy Needed:</b> Function writes directly to destination</li>
 * </ol>
 * 
...
public final class StructAssignmentGenerator {
     ...
     */
    public StructAssignmentGenerator(CodeGenContext context,
     ...
     * avoiding an extra copy. The function writes directly to the destination struct.
     * 
     ...
     */
    public void generateFromFunctionCall(NonTerminalNode lvalue, NonTerminalNode rvalue, 
                                        StructType structType, FunctionCallExtractor.FunctionCallInfo callInfo) {
     ...
     * Uses address generator to handle complex expressions like nested field access.
     * 
     * <p><b>Copy Algorithm:</b>
     * <ol>
     *   <li>Compute source address (rvalue)</li>
     *   <li>Compute destination address (lvalue)</li>
     *   <li>Copy struct word-by-word in a loop</li>
     * </ol>
     * 
     * @param lvalue the left-hand side (destination struct)
     ...
     * @param structType the struct type
     */
    public void generateStructCopy(NonTerminalNode lvalue, NonTerminalNode rvalue, StructType structType) {
        Objects.requireNonNull(lvalue, "lvalue must not be null");
        Objects.requireNonNull(rvalue, "rvalue must not be null");
        Objects.requireNonNull(structType, "structType must not be null");
        ...
        try {
            ...
            structSize = StructSizeCalculator.calculateStructSize(structType, arraySizes, nestedStructArraySizes);
        }
