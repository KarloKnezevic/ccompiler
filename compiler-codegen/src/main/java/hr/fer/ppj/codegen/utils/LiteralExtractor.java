 ...
 * 
 * <p>This utility class provides methods to extract integer and float literal
 * values from expression nodes, which is useful for constant folding optimizations.
 * 
...
public final class LiteralExtractor {
     ...
     * 
     * <p>This is used for optimization - if the operand is a float constant,
     * we can directly emit the negated Q16.16 value instead of computing it at runtime.
     * 
     * @param expr the expression node
