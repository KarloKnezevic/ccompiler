 ...
 *
 * <p>This exception indicates an error during the code generation phase, such as unsupported
 * language constructs, internal errors, or I/O failures when writing the output file.
 *
