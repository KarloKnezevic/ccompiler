 ...
 * 
 * <p>This class provides methods to recursively search parse tree nodes
 * for constant literals (integer numbers and character literals), handling
 * both positive and negative literals (unary minus).
 * 
 * <p><b>Supported Literals:</b>
 * <ul>
 *   <li>Integer constants (BROJ terminals)</li>
 *   <li>Character constants (ZNAK terminals) - converted to ASCII values</li>
 *   <li>Negative literals (unary minus applied to constants)</li>
...
public final class ConstantValueExtractor {
     ...
     * 
     * <p>This method navigates through expression wrappers (unary expressions,
     * cast expressions, etc.) to find the underlying constant literal, tracking
     * whether a unary minus was applied.
     * 
     * @param node the parse tree node to search
     * @param isChar whether to extract character literals (ZNAK) in addition to integers
     ...
     */
    private static String findConstantValueWithSign(NonTerminalNode node, boolean isChar, boolean isNegative) {
