...
print_next_steps() {
    ...
    echo -e "    ${CYAN}./run.sh <command> <file>${NC}"
    echo ""
    echo "  Or directly:"
    echo -e "    ${CYAN}java -jar $JAR_FILE <command> <file>${NC}"
    echo ""
    echo "  Available commands:"
    echo "    lexer    - Lexical analysis only"
    echo "    syntax   - Syntax analysis (includes lexical)"
    echo "    semantic - Semantic analysis (includes all previous phases)"
    echo "    run      - Execute FRISC assembly code"
    echo ""
}
