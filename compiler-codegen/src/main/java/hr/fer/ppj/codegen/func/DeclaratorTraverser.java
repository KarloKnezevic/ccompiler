 ...
 * 
 * <p>This class provides static methods for extracting variable names and array sizes
 * from declarator AST structures. It handles the complexity of nested declarators
 * and various array declaration patterns.
 * 
 * <p><b>Purpose:</b>
 * 
 * <p>When processing variable declarations, we need to extract:
 * <ul>
 *   <li>Variable names (IDN terminals)</li>
 *   <li>Array sizes (from {@code L_UGL_ZAGRADA BROJ D_UGL_ZAGRADA} patterns)</li>
 *   <li>Array size expressions (from {@code L_UGL_ZAGRADA <izraz> D_UGL_ZAGRADA} patterns)</li>
 * </ul>
 * 
 * <p>This class handles the recursive traversal of declarator structures to find
 * these elements, handling nested declarators correctly.
 * 
...
public final class DeclaratorTraverser {
     ...
     * 
     * <p>Searches for IDN terminals in the declarator structure, handling
     * nested declarators correctly.
     * 
     ...
     * 
     * <p>Looks for the pattern: {@code L_UGL_ZAGRADA BROJ D_UGL_ZAGRADA}
     * or {@code L_UGL_ZAGRADA <izraz> D_UGL_ZAGRADA}
     * 
     * @param directDeclarator the direct declarator node ({@code <izravni_deklarator>})
     ...
     * 
     * <p>Handles the pattern: {@code L_UGL_ZAGRADA <izraz> D_UGL_ZAGRADA}
     * by recursively searching for a BROJ terminal in the expression.
     * 
