 ...
 *
 * <p>Comparison operations return 1 (true) or 0 (false) in R0. The comparison is performed using
 * CMP instruction, followed by conditional jumps to set the result.
 *
...
public final class ComparisonOperationGenerator {
   ...
   */
  public ComparisonOperationGenerator(
  ...
  public void generateComparison(NonTerminalNode left, NonTerminalNode right, String operator) {
    ...
    context
        .emitter()
        .emitInstruction(jumpCondition, labels.trueLabel(), null, "comparison " + operator);
