 ...
 * 
 * <p>This function implements <b>float to integer conversion</b> by converting a
 * Q16.16 fixed-point value to a 32-bit signed integer. This is used when a float
 * value needs to be used in an integer context (e.g., array indexing, integer arithmetic).
 * 
 ...
 * </pre>
 * 
 * <p>This is equivalent to shifting the Q16.16 value right by 16 bits (arithmetic
 * shift for signed values), which divides by 2^16 = 65536 and truncates the fractional
 * part. The result is the integer part of the float value.
 * 
 ...
 * </pre>
 * 
 * <p>Therefore, shifting right by 16 bits (arithmetic shift) correctly extracts
 * the integer part and truncates the fractional part.
 * 
 * <p><b>Example:</b>
 * <pre>
 ...
 * <ul>
 *   <li>Positive values: Truncate downward (3.7 → 3)</li>
 *   <li>Negative values: Truncate upward (-3.7 → -3, not -4)</li>
 * </ul>
 * 
 * <p>However, arithmetic right shift (SHR for signed values) truncates towards
 * negative infinity:
 * <ul>
 *   <li>Positive values: 3.7 >> 16 = 3 (correct)</li>
 *   <li>Negative values: -3.7 >> 16 = -4 (may need adjustment)</li>
 * </ul>
 * 
 * <p>For this implementation, we use SHR which should work correctly for the
 * FRISC instruction set. If the instruction set uses arithmetic shift for SHR
 * on signed values, the truncation behavior will be correct.
 * 
 * <p><b>Why Right Shift by 16?</b>
 * 
 * <p>Shifting right by 16 bits is equivalent to dividing by 2^16 = 65536:
 * <ul>
 *   <li>It's faster than division (single instruction)</li>
 *   <li>It's exact (no rounding errors, just truncation)</li>
 *   <li>It preserves the sign (arithmetic right shift preserves sign bit)</li>
 * </ul>
 * 
 * <p><b>Edge Cases:</b>
 * <ul>
 *   <li><b>Zero:</b> 0 >> 16 = 0 (correctly represents 0)</li>
 *   <li><b>Negative Numbers:</b> Arithmetic right shift correctly handles
 *       negative values (sign bit is preserved)</li>
 *   <li><b>Fractional Part Zero:</b> Values with zero fractional part convert
 *       exactly (e.g., 2.0 → 2)</li>
 *   <li><b>Large Values:</b> Large float values may overflow when converted
 *       to integers, but this is acceptable (C standard behavior)</li>
 * </ul>
 * 
 * <p><b>Complexity Analysis:</b>
 * <ul>
 *   <li><b>Time Complexity:</b> O(1) - single SHR instruction</li>
 *   <li><b>Space Complexity:</b> O(1) - uses only registers</li>
 * </ul>
 * 
 * <p><b>FRISC Register Usage:</b>
 * <ul>
 *   <li><b>R0:</b> Input Q16.16 value, then result (integer)</li>
 *   <li><b>R6:</b> Return value (integer result)</li>
 * </ul>
 * 
