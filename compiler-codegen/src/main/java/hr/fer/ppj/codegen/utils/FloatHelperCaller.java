 ...
 *
 * <p>This class encapsulates the common pattern of calling float helper functions (F_FADD, F_FSUB,
 * F_FMUL, F_FDIV, F_FCMP) with proper argument pushing, function call, and stack cleanup. It
 * eliminates duplication across binary expression generators.
 *
 * <p><b>Calling Convention:</b>
 *
 * <ul>
 *   <li>Arguments are pushed right-to-left on the stack
 *   <li>Function is called via CALL instruction
 *   <li>Caller cleans up arguments (ADD R7, %D 8, R7)
 *   <li>Return value is in R6, moved to R0
 * </ul>
 *
...
public final class FloatHelperCaller {
   ...
   *
   * <p>Assumes R0 contains the left operand and R1 contains the right operand. After the call, R0
   * contains the result.
   *
